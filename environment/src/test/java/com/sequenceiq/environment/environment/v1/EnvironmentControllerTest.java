...
class EnvironmentControllerTest {
    ...
    void testRotateSaltPasswordByName() {
        ...
        when(environmentService.getByNameAndAccountId(eq("name"), anyString())).thenReturn(environmentDto);

        ThreadBasedUserCrnProvider.doAs(USER_CRN, () -> underTest.rotateSaltPasswordByName("name"));
