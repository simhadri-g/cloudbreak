...
public class FreeIpaCreationTest extends AbstractMockTest {
    ...
    public void testCreateFreeIpa(MockedTestContext testContext) throws IOException {
        ...
        String postRecipeName = resourcePropertyProvider().getName();
        ...
        testContext
                ...
                .withRecipe(Set.of(preRecipeName, postRecipeName, postInstallRecipeName, preTerminationRecipeName))
                ...
                .mockSalt().saltFileDistribute().post()
                    ...
                    .times(1).verify()
                .mockSalt().saltFileDistribute().post()
                .parameters(Map.of("file", postRecipeName, "path", "/srv/salt/pre-recipes/scripts", "permissions", "0600"),
                        DefaultResponseConfigure.ParameterCheck.HAS_THESE_PARAMETERS)
                .times(1).verify()
                .mockSalt().saltFileDistribute().post()
                ...
                .parameters(Map.of("file", preTerminationRecipeName, "path", "/srv/salt/pre-recipes/scripts", "permissions", "0600"),
                        DefaultResponseConfigure.ParameterCheck.HAS_THESE_PARAMETERS)
                .times(1).verify()
                .mockSalt().run().post().bodyContains("fun=grains.append", 1).times(3).verify()
