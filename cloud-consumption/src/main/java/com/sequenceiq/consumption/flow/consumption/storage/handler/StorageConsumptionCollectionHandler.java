...
import com.sequenceiq.consumption.service.EnvronmentService;
...
public class StorageConsumptionCollectionHandler  extends AbstractStorageOperationHandler {
    ...
    @Inject
    private EnvronmentService environmentService;
    ...
    public Selectable executeOperation(HandlerEvent<StorageConsumptionCollectionHandlerEvent> event) throws Exception {
        ...
        GetMetricStatisticsResult result = cloudWatchService.getBucketSize(cloudCredential,environmentService.getByCrn(environmentCrn)
                .getLocation().getName(),startTime,endTime,"cloudbreak-test");
